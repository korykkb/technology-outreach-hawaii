...
export default function Home() {
    return (
      ...
      */}
            ...
            <div id="newSection">
              ...
              <ul>
                ...
                <li>
                  ...
                  <p>Free virtual classNamees for teens teaches the basics of coding through peer mentorship with UH computer science students!</p>
                ...
                <li>
                  ...
                  <p>Free coding classNamees in Spring 2022 for 6th - 12th graders</p>
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <div className="carousel-row">
              <img className="carousel-image" src="/assets/images/carousel/0.jpg" alt="First slide"/>
              <img className="carousel-image" src="/assets/images/carousel/1.jpg" alt="First slide"/>
            </div>
          </div>
          <div className="carousel-item">
            <div className="carousel-row">
              <img className="carousel-image" src="/assets/images/carousel/2.png" alt="Second slide"/>
              <img className="carousel-image" src="/assets/images/carousel/3.png" alt="Second slide"/>
            </div>
          </div>
          <div className="carousel-item">
            <div className="carousel-row">
              <img className="carousel-image" src="/assets/images/carousel/4.jpg" alt="Third slide"/>
              <img className="carousel-image" src="/assets/images/carousel/5.png" alt="Third slide"/>
            </div>
          </div>
          <div className="carousel-item">
            <div className="carousel-row">
              <img className="carousel-image" src="/assets/images/carousel/6.jpg" alt="Fourth slide"/>
              <img className="carousel-image" src="/assets/images/carousel/7.jpg" alt="Fourth slide"/>
            </div>
          </div>
          <div className="carousel-item">
            <div className="carousel-row">
              <img className="carousel-image" src="/assets/images/carousel/8.jpg" alt="Fifth slide"/>
              <img className="carousel-image" src="/assets/images/carousel/9.jpg" alt="Fifth slide"/>
            </div>
          </div>
          <div className="carousel-item">
            <div className="carousel-row">
              <img className="carousel-image" src="/assets/images/carousel/10.jpg" alt="Sixth slide"/>
              <img className="carousel-image" src="/assets/images/carousel/11.jpg" alt="Sixth slide"/>
            </div>
          </div>
        </div>
      ...
      <div className="section" id="stand-section">
        {/* Our Vision Section */}
        ...
        <div className="stand-box">
          ...
          <div className="stand-layout">
            ...
            <div className="stand-individual">
